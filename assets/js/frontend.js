...
(function(){
  ...
  function buildAffordabilityInputs(form, id, tab, container){
    ...
    const fields = [
      ...
      {name:'homeowners_ins', label:'Homeowners Insurance (Yearly)', prefix:'$', step:100, min:0, decimals:0, default:getValue('homeowners_ins', 1200), modes:{amount:{label:'$', prefix:'$', suffix:'', decimals:0, step:100}, percent:{label:'%', prefix:'', suffix:'%', decimals:2, step:0.1}}, defaultMode:'amount'},
